/* 
    ...
    OBJETIVO 1: quando passar o mouse em cima da listagem, devemos
    selecioná-lo

        passo 1 - pegas os personagens no JS pra poder verificar quando o usuário 
        passar o mouse em cima de um deles
        passo 2 - adicionar os personagens no JS pra poder verificar quando o cursor do mouse
        passo 3 - verificar se já existia um personagem selecionado, se sim, devemos
...
// OBJETIVO 1: quando passar o mouse em cima da listagem, devemos selecioná-lo
// passo 1 - pegas os personagens no JS pra poder verificar quando o usuário passar o mouse em cima de um deles
